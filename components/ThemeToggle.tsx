...
export function ThemeToggle() {
  ...
  return <button className="themeToggle" onClick={toggle} aria-label={dark ? "Activer le mode clair" : "Activer le mode sombre"} title={dark ? "Mode clair" : "Mode sombre"}>{dark ? "☀" : "☾"}</button>;
}
