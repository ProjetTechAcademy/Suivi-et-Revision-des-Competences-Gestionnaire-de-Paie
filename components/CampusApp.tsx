...
function Brand({ compact = false }: { compact?: boolean }) {
  return (
    <span className={compact ? "brand compact" : "brand"}>
      <Image src="/brand/image_2.png" width={56} height={56} alt="Symbole officiel PAÏA" priority />
    ...
    <section className="hero" id="accueil">
      ...
      <div className="heroInner shell">
        ...
        <div className="heroMedallion" aria-label="Logo officiel PAÏA">
          ...
          <div className="logoDisc"><Image src="/brand/image_4.png" width={1080} height={1080} alt="Logo officiel PAÏA" priority /></div>
    ...
    <section className="sheetSection" id="fiche">
      <div className="shell"><h2>Aperçu d’une fiche Campus PAÏA</h2><div className="sheetLayout">
        ...
        <article className="knowledgeCard"><div className="domainRail">PAIE & SOCIAL</div><div className="knowledgeBody">
          <header><div><h1>{answer?.title || "DSN — Comprendre la déclaration sociale nominative"}</h1><p>De la logique déclarative au contrôle des données sociales</p></div><Image src="/brand/image_4.png" width={124} height={124} alt="Logo officiel PAÏA" /></header>
