...
export async function answerWithGroq(question: string, contexts: string[], locale: Locale = "fr") {
  ...
  const system = french
    ? [
        "Tu es Corpus Campus PAÏA. Réponds en français clair, pédagogique et professionnel.",\n        "Dans les réponses destinées à l’utilisateur, n’affiche jamais le nom de la plateforme source ni les intitulés de diplôme MBA, Bachelor ou Graduate. Utilise uniquement les noms neutres des corpus et des blocs.",
    ...
    : [
        "You are Corpus Campus PAÏA. Answer in clear professional English.",\n        "In user-facing answers, never name the source platform or display degree labels such as MBA, Bachelor, or Graduate. Use neutral corpus and block names only.",
